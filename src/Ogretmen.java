...
public class Ogretmen {
        ...
        do {
            ...
            switch (tercih) {
                ...
                case "Q":
                    ...
                    break;
                default:
                    System.out.println("Lutfen gecerli tercih yapin");
            }
    ...
    private static void tcNoIleOgretmenSil() {
        System.out.println("");
        int index=0;
    ...
    public static void branstanOgretmenBulma() throws InterruptedException {
        ...
        File file = new File("src/ogrt.text");
        try {
    ...
    public static void ogretmenGetir() throws FileNotFoundException {
